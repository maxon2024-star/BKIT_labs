...
def main():
    ...
    @unit_test(input=[], output=[{
        ...
        "Boeing 737 flight(self-education). Редакция 2": ("Глава 2", 91),
    ...
    @unit_test(input =[], output = [{
        "Boeing 737 flight(self-education)": [("Глава 1", 10, "Boeing 737 flight(self-education)"),
                                             ("Глава 2", 91, "Boeing 737 flight(self-education)")],
        "МЦТ США. История": [("Глава 33", 50, "МЦТ США. История")],
        "Апчихба и другие мемы": [("Глава 5", 20, "Апчихба и другие мемы"),
                                  ("Глава 69", 30, "Апчихба и другие мемы")],
        "Boeing 737 flight(self-education). Редакция 2": [("Глава 1", 10, "Boeing 737 flight(self-education). Редакция 2"),
                                                         ("Глава 2", 91, "Boeing 737 flight(self-education). Редакция 2")],
        "МЦТ США. История (переписанная)": [("Глава 33", 50, "МЦТ США. История (переписанная)")],
        "Апчихба и другие мемы. Редакция 2": [("Глава 5", 20, "Апчихба и другие мемы. Редакция 2"),
                                             ("Глава 69", 30, "Апчихба и другие мемы. Редакция 2")],
    }])
